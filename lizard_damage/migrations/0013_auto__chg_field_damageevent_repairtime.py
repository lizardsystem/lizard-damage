...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DamageEvent.repairtime'
        db.alter_column('lizard_damage_damageevent', 'repairtime', self.gf('django.db.models.fields.FloatField')(null=True))


    def backwards(self, orm):
        
        # User chose to not deal with backwards NULL issues for 'DamageEvent.repairtime'
        raise RuntimeError("Cannot reverse this migration. 'DamageEvent.repairtime' and its values cannot be restored.")
    ...
    models = {
        ...
        'lizard_damage.damageevent': {
            ...
            'repairtime': ('django.db.models.fields.FloatField', [], {'default': 'None', 'null': 'True', 'blank': 'True'}),
