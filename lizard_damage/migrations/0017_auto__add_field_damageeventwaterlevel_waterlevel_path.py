...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DamageEventWaterlevel.waterlevel_path'
        db.add_column(u'lizard_damage_damageeventwaterlevel', 'waterlevel_path',
                      self.gf('django.db.models.fields.FilePathField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DamageEventWaterlevel.waterlevel_path'
        db.delete_column(u'lizard_damage_damageeventwaterlevel', 'waterlevel_path')
