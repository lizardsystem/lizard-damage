...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lizard_damage_damagescenario', 'damagetable', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DamageScenario.damagetable'
        db.delete_column('lizard_damage_damagescenario', 'damagetable')
