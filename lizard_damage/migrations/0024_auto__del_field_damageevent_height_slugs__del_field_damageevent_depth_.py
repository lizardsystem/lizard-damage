...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.delete_column(u'lizard_damage_damageevent', 'height_slugs')

        # Deleting field 'DamageEvent.depth_slugs'
        db.delete_column(u'lizard_damage_damageevent', 'depth_slugs')

        # Deleting field 'DamageEvent.landuse_slugs'
        db.delete_column(u'lizard_damage_damageevent', 'landuse_slugs')

        # Deleting field 'DamageEvent.result'
        db.delete_column(u'lizard_damage_damageevent', 'result')


    def backwards(self, orm):
        
        # Adding field 'DamageEvent.height_slugs'
        db.add_column(u'lizard_damage_damageevent', 'height_slugs', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DamageEvent.depth_slugs'
        db.add_column(u'lizard_damage_damageevent', 'depth_slugs', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DamageEvent.landuse_slugs'
        db.add_column(u'lizard_damage_damageevent', 'landuse_slugs', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)

        # Adding field 'DamageEvent.result'
        db.add_column(u'lizard_damage_damageevent', 'result', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
