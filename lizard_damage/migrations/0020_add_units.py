...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        """Fill Units table if not filled yet"""

        # Taken from the existing table at www.waterschadeschatter.nl,
        # 20140818
        UNITS = {
            "/m2": 1.0,
            "/ha": 0.0001,
            "/dag": 1.15740740741e-05,
            "uur": 3600.0,
            "dag": 86400.0,
            "dagen": 86400.0,
            "/m2/dag": 1.0,
        ...
        for name, factor in UNITS.items():
            orm['lizard_damage.Unit'].objects.get_or_create(
