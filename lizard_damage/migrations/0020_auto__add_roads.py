...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Roads'
        db.create_table(u'data_roads', (
            ('gid', self.gf('django.db.models.fields.IntegerField')(primary_key=True)),
            ('typeinfr_1', self.gf('django.db.models.fields.CharField')(max_length=25, blank=True)),
            ('typeweg', self.gf('django.db.models.fields.CharField')(max_length=120, blank=True)),
            ('gridcode', self.gf('django.db.models.fields.SmallIntegerField')(null=True, blank=True)),
            ('the_geom', self.gf('django.contrib.gis.db.models.fields.MultiPolygonField')(srid=28992, null=True, blank=True)),
        ))
        db.send_create_signal('lizard_damage', ['Roads'])


    def backwards(self, orm):
        
        # Deleting model 'Roads'
        db.delete_table(u'data_roads')
