...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'BenefitScenario.status'
        db.add_column('lizard_damage_benefitscenario', 'status', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'BenefitScenario.status'
        db.delete_column('lizard_damage_benefitscenario', 'status')
