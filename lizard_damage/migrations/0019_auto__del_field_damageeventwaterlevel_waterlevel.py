...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DamageEventWaterlevel.waterlevel'
        db.delete_column(u'lizard_damage_damageeventwaterlevel', 'waterlevel')


    def backwards(self, orm):

        # User chose to not deal with backwards NULL issues for 'DamageEventWaterlevel.waterlevel'
        raise RuntimeError("Cannot reverse this migration. 'DamageEventWaterlevel.waterlevel' and its values cannot be restored.")
