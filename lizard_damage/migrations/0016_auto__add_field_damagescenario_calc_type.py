...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DamageScenario.calc_type'
        db.add_column('lizard_damage_damagescenario', 'calc_type', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DamageScenario.calc_type'
        db.delete_column('lizard_damage_damagescenario', 'calc_type')
