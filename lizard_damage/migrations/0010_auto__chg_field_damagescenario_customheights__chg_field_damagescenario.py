...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'DamageScenario.customheights'
        db.alter_column('lizard_damage_damagescenario', 'customheights', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True))

        # Changing field 'DamageScenario.customlanduse'
        db.alter_column('lizard_damage_damagescenario', 'customlanduse', self.gf('django.db.models.fields.FilePathField')(max_length=100, null=True))


    def backwards(self, orm):
        
        # Changing field 'DamageScenario.customheights'
        db.alter_column('lizard_damage_damagescenario', 'customheights', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))

        # Changing field 'DamageScenario.customlanduse'
        db.alter_column('lizard_damage_damagescenario', 'customlanduse', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True))
