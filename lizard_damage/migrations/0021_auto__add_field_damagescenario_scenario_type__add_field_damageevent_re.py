...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DamageScenario.scenario_type'
        db.add_column('lizard_damage_damagescenario', 'scenario_type', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'DamageEvent.repetition_time'
        db.add_column('lizard_damage_damageevent', 'repetition_time', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DamageScenario.scenario_type'
        db.delete_column('lizard_damage_damagescenario', 'scenario_type')

        # Deleting field 'DamageEvent.repetition_time'
        db.delete_column('lizard_damage_damageevent', 'repetition_time')
