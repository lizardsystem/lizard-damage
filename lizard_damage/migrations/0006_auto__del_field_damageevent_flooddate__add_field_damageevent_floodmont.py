...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DamageEvent.flooddate'
        db.delete_column('lizard_damage_damageevent', 'flooddate')

        # Adding field 'DamageEvent.floodmonth'
        db.add_column('lizard_damage_damageevent', 'floodmonth', self.gf('django.db.models.fields.IntegerField')(default=9), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'DamageEvent.flooddate'
        db.add_column('lizard_damage_damageevent', 'flooddate', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2012, 9, 4, 10, 23, 29, 13241)), keep_default=False)

        # Deleting field 'DamageEvent.floodmonth'
        db.delete_column('lizard_damage_damageevent', 'floodmonth')
