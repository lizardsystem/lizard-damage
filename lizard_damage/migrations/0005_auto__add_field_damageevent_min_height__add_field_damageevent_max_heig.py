...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DamageEvent.min_height'
        db.add_column('lizard_damage_damageevent', 'min_height', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)

        # Adding field 'DamageEvent.max_height'
        db.add_column('lizard_damage_damageevent', 'max_height', self.gf('django.db.models.fields.FloatField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DamageEvent.min_height'
        db.delete_column('lizard_damage_damageevent', 'min_height')

        # Deleting field 'DamageEvent.max_height'
        db.delete_column('lizard_damage_damageevent', 'max_height')
