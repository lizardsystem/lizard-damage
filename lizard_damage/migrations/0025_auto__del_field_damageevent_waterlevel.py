...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DamageEvent.waterlevel'
        db.delete_column('lizard_damage_damageevent', 'waterlevel')


    def backwards(self, orm):
        
        # Adding field 'DamageEvent.waterlevel'
        db.add_column('lizard_damage_damageevent', 'waterlevel', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
