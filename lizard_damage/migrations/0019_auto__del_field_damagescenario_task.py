...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DamageScenario.task'
        db.delete_column('lizard_damage_damagescenario', 'task_id')


    def backwards(self, orm):
        
        # Adding field 'DamageScenario.task'
        db.add_column('lizard_damage_damagescenario', 'task', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_task.SecuredPeriodicTask'], null=True, blank=True), keep_default=False)
