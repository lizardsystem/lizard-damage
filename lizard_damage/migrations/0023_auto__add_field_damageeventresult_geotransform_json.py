...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DamageEventResult.geotransform_json'
        db.add_column(u'lizard_damage_damageeventresult', 'geotransform_json',
                      self.gf('django.db.models.fields.TextField')(null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DamageEventResult.geotransform_json'
        db.delete_column(u'lizard_damage_damageeventresult', 'geotransform_json')
