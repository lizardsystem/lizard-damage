...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DamageEventWaterlevel.index'
        db.add_column('lizard_damage_damageeventwaterlevel', 'index', self.gf('django.db.models.fields.IntegerField')(default=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DamageEventWaterlevel.index'
        db.delete_column('lizard_damage_damageeventwaterlevel', 'index')
