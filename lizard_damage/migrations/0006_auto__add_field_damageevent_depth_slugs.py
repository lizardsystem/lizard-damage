...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('lizard_damage_damageevent', 'depth_slugs', self.gf('django.db.models.fields.TextField')(null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DamageEvent.depth_slugs'
        db.delete_column('lizard_damage_damageevent', 'depth_slugs')
