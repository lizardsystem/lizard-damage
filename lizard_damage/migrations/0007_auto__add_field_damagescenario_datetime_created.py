...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DamageScenario.datetime_created'
        db.add_column('lizard_damage_damagescenario', 'datetime_created', self.gf('django.db.models.fields.DateTimeField')(auto_now=True, default=datetime.datetime(2012, 9, 4, 12, 8, 35, 982401), blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DamageScenario.datetime_created'
        db.delete_column('lizard_damage_damagescenario', 'datetime_created')
