...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'DamageEventResult.image'
        db.delete_column(u'lizard_damage_damageeventresult', 'image')

        # Adding field 'DamageEventResult.relative_path'
        db.add_column(u'lizard_damage_damageeventresult', 'relative_path',
    ...
    def backwards(self, orm):
        ...
        # User chose to not deal with backwards NULL issues for 'DamageEventResult.image'
        raise RuntimeError("Cannot reverse this migration. 'DamageEventResult.image' and its values cannot be restored.")
        # Deleting field 'DamageEventResult.relative_path'
        db.delete_column(u'lizard_damage_damageeventresult', 'relative_path')
