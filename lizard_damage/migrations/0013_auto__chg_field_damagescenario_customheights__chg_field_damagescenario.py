...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('lizard_damage_damagescenario', 'customheights', self.gf('django.db.models.fields.FilePathField')(max_length=200, null=True))

        # Changing field 'DamageScenario.customlanduse'
        db.alter_column('lizard_damage_damagescenario', 'customlanduse', self.gf('django.db.models.fields.FilePathField')(max_length=200, null=True))
