...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DamageScenario.damagetable'
        db.delete_column(u'lizard_damage_damagescenario', 'damagetable')


    def backwards(self, orm):
        
        # Adding field 'DamageScenario.damagetable'
        db.add_column(u'lizard_damage_damagescenario', 'damagetable', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)
