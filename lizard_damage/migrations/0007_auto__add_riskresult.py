...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RiskResult'
        db.create_table('lizard_damage_riskresult', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('zip_risk', self.gf('django.db.models.fields.files.FileField')(max_length=100)),
            ('scenario', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['lizard_damage.DamageScenario'])),
        ))
        db.send_create_signal('lizard_damage', ['RiskResult'])


    def backwards(self, orm):
        
        # Deleting model 'RiskResult'
        db.delete_table('lizard_damage_riskresult')
