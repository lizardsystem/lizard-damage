...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'DamageEvent.repairtime'
        db.delete_column('lizard_damage_damageevent', 'repairtime')

        # Adding field 'DamageEvent.repairtime_roads'
        db.add_column('lizard_damage_damageevent', 'repairtime_roads', self.gf('django.db.models.fields.FloatField')(default=432000), keep_default=False)

        # Adding field 'DamageEvent.repairtime_buildings'
        db.add_column('lizard_damage_damageevent', 'repairtime_buildings', self.gf('django.db.models.fields.FloatField')(default=432000), keep_default=False)


    def backwards(self, orm):
        
        # Adding field 'DamageEvent.repairtime'
        db.add_column('lizard_damage_damageevent', 'repairtime', self.gf('django.db.models.fields.FloatField')(default=None, null=True, blank=True), keep_default=False)

        # Deleting field 'DamageEvent.repairtime_roads'
        db.delete_column('lizard_damage_damageevent', 'repairtime_roads')

        # Deleting field 'DamageEvent.repairtime_buildings'
        db.delete_column('lizard_damage_damageevent', 'repairtime_buildings')
