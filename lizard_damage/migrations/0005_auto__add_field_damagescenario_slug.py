...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DamageScenario.slug'
        db.add_column('lizard_damage_damagescenario', 'slug', self.gf('django.db.models.fields.SlugField')(db_index=True, max_length=50, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DamageScenario.slug'
        db.delete_column('lizard_damage_damagescenario', 'slug')
