...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'lizard_damage_damageeventresult', 'result_type',
                      self.gf('django.db.models.fields.CharField')(default='damage', max_length=10),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DamageEventResult.result_type'
        db.delete_column(u'lizard_damage_damageeventresult', 'result_type')
