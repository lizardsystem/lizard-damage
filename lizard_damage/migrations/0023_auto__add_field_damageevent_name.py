...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DamageEvent.name'
        db.add_column('lizard_damage_damageevent', 'name', self.gf('django.db.models.fields.CharField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DamageEvent.name'
        db.delete_column('lizard_damage_damageevent', 'name')
