...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'DamageScenario.damagetable_file'
        db.add_column(u'lizard_damage_damagescenario', 'damagetable_file',
                      self.gf('django.db.models.fields.FilePathField')(max_length=200, null=True, blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'DamageScenario.damagetable_file'
        db.delete_column(u'lizard_damage_damagescenario', 'damagetable_file')
