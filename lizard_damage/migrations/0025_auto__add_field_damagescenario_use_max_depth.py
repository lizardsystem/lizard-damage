...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'DamageScenario.use_max_depth'
        db.add_column(u'lizard_damage_damagescenario', 'use_max_depth', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'DamageScenario.use_max_depth'
        db.delete_column(u'lizard_damage_damagescenario', 'use_max_depth')
    ...
    models = {
        ...
        u'lizard_damage.damagescenario': {
            ...
            'slug': ('django.db.models.fields.SlugField', [], {'db_index': 'True', 'max_length': '50', 'null': 'True', 'blank': 'True'}),
            'status': ('django.db.models.fields.IntegerField', [], {'default': '1'}),
            'use_max_depth': ('django.db.models.fields.BooleanField', [], {'default': 'False'})
        },
